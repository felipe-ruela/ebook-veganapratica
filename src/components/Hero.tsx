...
const Hero = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    "Olá! Tenho interesse no eBook '30 Receitas Veganas Rápidas' por R$9,99. Como posso adquirir?"
  );
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-white/90 leading-relaxed">
                Transforme sua alimentação com receitas práticas, saudáveis e
                deliciosas. Perfeitas para quem quer emagrecer, ter mais energia
                e cuidar da saúde!
              </p>
            </div>
